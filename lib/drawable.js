...
Drawable.prototype.rotate_children = function(){
    ...
    for (var i = 0; i < count; i++) {
        ...
        var cp = child.bounds.pos;
        console.log(cp);
        
        var x = cp.x - pos.x;
        var y = cp.y - pos.y;
        child.translate_bounds_to(x,y);
        child.rotate_to(this.angle);
        child.translate_bounds_to(cp.x,cp.y);
