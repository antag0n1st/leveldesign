...
//            
//                     
//            if(node.iterator < node.children.length){
//                if(node.iterator === 0){
//                    node.draw(context);
//                    this.draw_objects++;
////                    if (node.is_children_sortable) {
////                        this.sort_objects(node.children);
////                    }
//                }
//                node.iterator++;                  
//                node = node.children[node.iterator-1];               
//            }else {
//                                
//                if(node.iterator === node.children.length){
//                     node.draw(context);  
//                     this.draw_objects++;
//                     node.on_draw_finished(context);
//                }else{
//                     node.on_draw_finished(context);
//                } 
//                
